 ...
 h = 1.28;
	...
	class controls {
		...
		*/
		...
		this setObjectTexture [0,"images\arma3apex.jpg"];
		this addAction["Black Market Production",{[] spawn life_fnc_craft}];
		
		this allowDamage false; this enableSimulation false; 
		this setObjectTexture [0,"images\arma3apex.jpg"]; this addAction["Black Market Production",life_fnc_craft,"blackmarket",0,false,false,"",' playerSide == civilian '];
		this addAction["Black Market",life_fnc_virt_menu,"blackmarket",0,false,false,"",' playerSide == civilian ']; 
		
		this addAction["Vehicle Garage",life_fnc_vehicleGarage,"car"];
		*/
